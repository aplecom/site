...
class Order(models.Model):
    ...
    land_area = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="Площадь земли (в кв. м)")
    land_processing_date = models.DateField(null=True, blank=True, verbose_name="Дата обработки земли")
...
class OrderItem(models.Model):
    ...
    created_timestamp = models.DateTimeField(auto_now_add=True, verbose_name="Дата сделки")
